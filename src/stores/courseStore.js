...
var COURSE_CHANGE_EVENT = 'course_change';

var _courses = [];

var CourseStore = assign({}, EventEmitter.prototype, {
    addChangeListener: function(callback){
        this.on(COURSE_CHANGE_EVENT, callback);
    },
    removeChangeListener: function(callback){
        this.removeListener(COURSE_CHANGE_EVENT, callback);   
    },
    emitChange: function(){
        this.emit(COURSE_CHANGE_EVENT);
    },
